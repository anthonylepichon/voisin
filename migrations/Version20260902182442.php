...
final class Version20260902182442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, utilisateur_id INT NOT NULL, publication_id INT NOT NULL, INDEX idx_commentaire_utilisateur (utilisateur_id), INDEX idx_commentaire_publication (publication_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT DEFAULT NULL, nom_image VARCHAR(255) DEFAULT NULL, visibilite VARCHAR(20) NOT NULL, date_creation DATETIME NOT NULL, utilisateur_id INT NOT NULL, INDEX idx_publication_utilisateur (utilisateur_id), INDEX idx_publication_visibilite_creation (visibilite, date_creation), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC60BB6FE6 FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE RESTRICT');
        ...
        $this->addSql('ALTER TABLE publication ADD CONSTRAINT FK_AF3C677960BB6FE6 FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE RESTRICT');
